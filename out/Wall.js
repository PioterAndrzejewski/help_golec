...
class Wall extends NBody {
    constructor(scene, x, y, stiffness = 1, mass = 9) {
        super(scene, mass);
        // Create vertices.
    ...
    rotate(angle) {
        ...
        for (const vert of this.vertices) {
            ...
            vert.set(this.center.x + register0.x * cos - register0.y * sin, this.center.y + register0.x * sin + register0.y * cos);
            vert.integrate();
        }
    }
    paint(canvas, t) {
        ...
        canvas.save();
        canvas.clip();
        canvas.drawImage(WALL_PICTURE, 0, 0, 960 /* Settings.screenWidth */, 540 /* Settings.screenHeight */);
        canvas.restore();
        // Paint edges.
