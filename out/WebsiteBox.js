...
class WebsiteBox extends NBody {
    constructor(scene, x, y, stiffness = 0.5, mass = 1) {
        super(scene, mass);
        // Create vertices.
        const v0 = new NVertex(this, x, y);
        const v1 = new NVertex(this, x + 110 /* Settings.websiteWidth */, y);
        const v2 = new NVertex(this, x + 110 /* Settings.websiteWidth */, y + 196 /* Settings.websiteHeight */);
        const v3 = new NVertex(this, x, y + 196 /* Settings.websiteHeight */);
        // Create edges.
        ...
        this.center.set(x + 0.5 * 110 /* Settings.websiteWidth */, y + 0.5 * 196 /* Settings.websiteHeight */);
        this.halfExtents.set(0.5 * 110 /* Settings.websiteWidth */, 0.5 * 196 /* Settings.websiteHeight */);
    }
    paint(canvas, t) {
