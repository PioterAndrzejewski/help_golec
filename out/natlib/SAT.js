...
const satResolve = (function () {
    ...
    function sat(b0, b1) {
        ...
        if (b0EdgesLength === 0 || b1EdgesLength === 0)
            return;
        // aabb overlap test
    ...
    function resolve() {
        ...
        // collision friction
        if (0 /* Settings.kFriction */) {
            // compute relative velocity
            register0.set(pos.x - old.x - (pos0.x + pos1.x - old0.x - old1.x) * 0.5, pos.y - old.y - (pos0.y + pos1.y - old0.y - old1.y) * 0.5);
            ...
            old0.x -= register0.x * 0 /* Settings.kFriction */ * k0;
            old0.y -= register0.y * 0 /* Settings.kFriction */ * k0;
            old1.x -= register0.x * 0 /* Settings.kFriction */ * k1;
            old1.y -= register0.y * 0 /* Settings.kFriction */ * k1;
            old.x += register0.x * 0 /* Settings.kFriction */ * c1;
            old.y += register0.y * 0 /* Settings.kFriction */ * c1;
        }
    }
    return sat;
})();
