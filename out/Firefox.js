...
const FIREFOX_BACK = canvas.createRadialGradient(256, 512 + 64, 256, 256, -256 + 64, 256);
...
const EARTH_BACK = canvas.createLinearGradient(0, 540 /* Settings.screenHeight */, 960 /* Settings.screenWidth */, 0);
